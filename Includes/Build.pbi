...
Procedure Build_Line_Player(Player_Number, Map_ID, X_0, Y_0, Z_0, X_1, Y_1, Z_1, Material, Priority, Undo, Physic) ; - Builds a line between two points.
    Protected D_X.l, D_Y.l, D_Z.l, Blocks.l, M_X.f, M_Y.f, M_Z.f, *Player.Player_List, *Map.Map_Data, i.l
    ...
    *Player = Player_List_Get_Pointer(Player_Number)
    *Map = Map_Get_Pointer(Map_ID)
    
    For i = 0 To Blocks
        Map_Block_Change_Player(*Player, *Map, X_0+M_X*i, Y_0+M_Y*i, Z_0+M_Z*i, Material, Undo, Physic, 1, Priority)
    Next
EndProcedure
...
Procedure Build_Box_Player(Player_Number, Map_ID, X_0, Y_0, Z_0, X_1, Y_1, Z_1, Material, Replace_Material, Hollow, Priority, Undo, Physic) ; - Fills the area between two points.
    Protected ix.l, iy.l, iz.l
    Protected X_2.l, Y_2.l, Z_2.l
...
Procedure Build_Sphere_Player(Player_Number, Map_ID, X, Y, Z, R.f, Material, Replace_Material, Hollow, Priority, Undo, Physic)
    Protected R_Rounded.f, R_Pow.f, *Player.Player_List, *Map.Map_Data
    Protected ix.l, iy.l, iz.l
    Protected Square_Dist.f, AllocateMemory.b
        ...
        For iy = -R_Rounded To R_Rounded
            For iz = -R_Rounded To R_Rounded
                ...
                If Square_Dist <= R_Pow
                    ...
                    If Allowed
                        If Replace_Material = -1 Or Replace_Material = Map_Block_Get_Type(*Map, X+ix, Y+iy, Z+iz)
                            Map_Block_Change_Player(*Player, *Map, X+ix, Y+iy, Z+iz, Material, Undo, Physic, 1, Priority)
                        EndIf
                    EndIf
                EndIf
            Next
