                    ...
                    If Compressed_Size <> -1
                        If Network_Client_Select(Client_ID)
                            ...
                            While Bytes_2_Send > 0
                                ...
                                SendMapData(Network_Client()\ID, Bytes_In_Block, *Temp_Buffer_2 + Bytes_Sent, Bytes_Sent*100/Compressed_Size)
...
;                                 Network_Client_Output_Write_Byte(Network_Client()\ID, Bytes_Sent*100/Compressed_Size)
                            ...
                            SendMapFinalize(Network_Client()\ID, Map_Size_X, Map_Size_Y, Map_Size_Z)
